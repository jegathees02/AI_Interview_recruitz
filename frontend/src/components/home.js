            ...
            <div class="flex flex-col space-y-8 ">
              <div className="flex">
                ...
                <div className="space-y-2 xl:pt-56">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-teal-400">
                    Discover Our Unique Features
                  </h1>
                  <p className="text-black  md:text-xl dark:text-black-900 mx-auto">
              ...
              <div>
                <div
                  class="w-full  max-w-full xl:pt-72 space-y-4 mx-auto text-center"
                  
                >
                  <div class="text-center">
                 
                    <h1 class="text-4xl font-bold mb-4 subpixel-antialiased tracking-tighter ">
                    <Typewriter
                onInit={(typewriter) => {
                    typewriter
                        .typeString("We came up with")
                        .pauseFor(2000)
                  ...
                  <div class="grid grid-cols-3 gap-8"data-aos="fade-up" >
                    ...
                    <div className="bg-opacity-50 bg-gray-50 rounded-lg shadow-lg p-5  backdrop-filter hover:shadow-2xl">
                      <div class="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                        ...
                        <h2 class="text-xl font-bold text-teal-500 hover:text-black">
                          Easy Access
                        </h2>
                        <p class="text-black-200 dark:text-black-100">
                          Easy Access allows you to share and edit documents
